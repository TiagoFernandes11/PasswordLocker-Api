...
public interface UserRepository extends JpaRepository<UserModel, String>, JpaSpecificationExecutor<UserModel> {
    ...
    public final static String FIND_BY_ID = "SELECT * FROM TB_USER WHERE ID_USER = :idUser";
    public final static String DELETE_BY_ID = "DELETE FROM TB_USER WHERE ID_USER = :idUser";
